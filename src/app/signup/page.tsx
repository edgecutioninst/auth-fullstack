        ...
        >
            <div className="w-full max-w-md bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-3xl shadow-2xl">
                <h1 className="text-4xl font-extrabold text-white text-center mb-2">
                    {loading ? "Processing..." : "Join the Journey"}
                </h1>
                <p className="text-gray-200 text-center mb-8 font-medium">Create your account to start exploring</p>

                <hr className="border-white/20 mb-8" />

                <div className="space-y-5">
                    <div className="flex flex-col">
                        <label className="text-white text-sm font-semibold mb-1 ml-1" htmlFor="username">Username</label>
                        <input
                    ...
                    >
                        {buttonDisabled ? "Fill all fields" : (loading ? "Creating Account..." : "Sign Up")}
                    </button>
                </div>
                ...
                <div className="mt-8 text-center">
                    <p className="text-neutral-800 font-medium">
                        ...
                        <Link href="/login" className="text-orange-600 font-bold hover:underline hover:text-orange-700">
                            Login here
                        </Link>
                    </p>
                </div>
